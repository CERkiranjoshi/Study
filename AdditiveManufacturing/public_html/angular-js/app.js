'use strict';
var AngularLessons = {};
var App = angular.module('AdditiveManufacturing', ['ngRoute', 'smart-table','AngularLessons.directives', 'AngularLessons.services', 'AngularLessons.filters']).config(['$routeProvider', '$httpProvider', function ($routeProvider, $httpProvider) {
